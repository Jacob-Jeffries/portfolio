...
function Portfolio() {
    return(
        <section className="card" id="mc01">
            <aside className="mc-aside" id="a-mc01">
            ...
            <section id="Portfolio_Carousel" className="text">
                <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel" data-interval="10000">
                    <div className="carousel-inner">
                        <div className="carousel-item active" data-name="Social Media Back End | Module 18">
                        <img className="d-block w-100" src="./assets/images/SM_BE_insomia.JPG" alt="Insomnia Routes screenshot"/>
                        <div className="carousel-caption text-center title">
                        ...
                        <div className="carousel-item" data-name="Rate My Pet | Project 2">
                        <img className="d-block w-100" src="./assets/images/Petstar.png" alt="Petstar screenshot"/>
                        <div className="carousel-caption text-center title">
                        ...
                        <div className="carousel-item" data-name="E-commerce Sequelize Backend API | Module 13">
                        <img className="d-block w-100" src="./assets/images/E-Commerce.JPG" alt="E-commerce screenshot"/>
                        <div className="carousel-caption text-center title">
                        ...
                        <div className="carousel-item" data-name="Employee Management System  | Module 12">
                        <img className="d-block w-100" src="./assets/images/EMS.JPG" alt="Employee Management System screenshot"/>
                        <div className="carousel-caption text-center title">
                        ...
                        <div className="carousel-item" data-name="Note Taker App  | Module 11">
                        <img className="d-block w-100" src="./assets/images/noteTaker.png" alt="Note Taker App Screenshot"/>
                        <div className="carousel-caption text-center title">
                        ...
                        <div className="carousel-item" data-name="Team Builder CLI  | Module 10">
                        <img className="d-block w-100" src="./assets/images/lotr_team.png" alt="Team Builder App Screenshot"/>
                        <div className="carousel-caption text-center title">
                        ...
                        <div className="carousel-item" data-name="README Builder CLI  | Module 9">
                        <img className="d-block w-100" src="./assets/images/cli_readme.jpg" alt="Team Builder App Screenshot"/>
                        <div className="carousel-caption text-center title">
                        ...
                        <div className="carousel-item" data-name="MiTrip  | Project 1">
                        <img className="d-block w-100" src="./assets/images/MiTrip.png" alt="MiTrip App Screenshot"/>
                        <div className="carousel-caption text-center title">
                        ...
                        <div className="carousel-item" data-name="Daily Scheduler  | Module 5">
                        <img className="d-block w-100" src="./assets/images/Scheduler.png" alt="Scheduler App Screenshot"/>
                        <div className="carousel-caption text-center title">
                        ...
                        <div className="carousel-item" data-name="Quiz  | Module 4">
                        <img className="d-block w-100" src="./assets/images/quiz.png" alt="Quiz App Screenshot"/>
                        <div className="carousel-caption text-center title">
                        ...
                        <div className="carousel-item" data-name="Password Gen  | Module 3"> 
                        <img className="d-block w-100" src="./assets/images/passgen.png" alt="Password Generator App Screenshot"/>
                        <div className="carousel-caption text-center title">
